package com.sp4a.zhihudaily.view
...
import com.sp4a.R
import com.sp4a.manager.BaseFragment
...
import com.sp4a.zhihudaily.model.bean.ZhiHuDailyItem
import com.sp4a.zhihudaily.model.fetchZhiHuDailyDetailById
import com.sp4a.zhihudaily.model.fetchZhiHuDailyListByDate
    ...
    private fun initPtr() {
        ...
        ptrFrameOfZhiHuDaily.setPtrHandler(object : PtrDefaultHandler() {
            ...
            override fun checkCanDoRefresh(frame: PtrFrameLayout?, content: View?, header: View?): Boolean {
                return !recyclerViewRiBao.canScrollVertically(-1) && (activity as com.sp4a.IndexActivity).appBarLayoutVerticalOffset >= 0
            }
        })
    }
