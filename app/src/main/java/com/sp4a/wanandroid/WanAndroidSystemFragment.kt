...
import com.sp4a.util.inflate
import com.sp4a.util.startBrowserActivity
import com.sp4a.wanandroid.model.bean.RecommendItem
import com.sp4a.wanandroid.model.bean.SystemTag
import com.sp4a.wanandroid.model.bean.SystemTagArticleList
import com.sp4a.wanandroid.model.collectInsideArticle
import com.sp4a.wanandroid.model.fetchSystemTagArticleList
import com.sp4a.wanandroid.model.fetchSystemTagList
import com.sp4a.wanandroid.model.unCollectInsideArticle
import com.sp4a.widget.LoadingDialog
import com.sp4a.widget.WishListIconView
...
class WanAndroidSystemFragment : WanAndroidBaseFragment() {
    ...
    override fun checkRefresh(): Boolean {
        return sv_system_tag_all.visibility != View.VISIBLE
                ...
                && (activity as com.sp4a.IndexActivity).appBarLayoutVerticalOffset >= 0
    }
